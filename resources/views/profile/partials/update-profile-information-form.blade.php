<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <x-text-input id="username" name="username" type="text" class="mt-1 block w-full" :value="old('username', $user->name)"
        ...
        {{-- Upload Avatar --}}
        <div>
            <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-white" for="avatar">Upload
                avatar</label>
            <input
        ...
        <div>
            <img class="w-20 h-20 rounded-full"
                src="{{ $user->avatar ? asset($user->avatar) : asset('img/photo.png') }}" alt="{{ $user->name }}">
        </div>
